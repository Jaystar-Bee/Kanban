<template>
  ...
  <aside
    class="w-[20%] border-r dark:border-primary-dark-3 border-primary-lighter h-[100%] text-primary-dark-4 pt-10 dark:bg-primary-dark-1 duration-500"
  >
    <h2 class="pl-8 mb-8 font-semibold">ALL BOARDS ({{ numberOfBoard }})</h2>
    <nav
      class="flex flex-col space-y-6 mt-4 h-[70%] overflow-y-scroll overflow-x-hidden"
    >
      ...
      <div
        class="flex items-center text-primary space-x-3 pl-8 cursor-pointer font-bold"
